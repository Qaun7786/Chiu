...
getgenv().Melee = { 
    ["Melee"] = true,
    ["Delay"] = 1,
    ["Skill Z"] = true, ["TimeSkillZ"] = "1",
    ["Skill X"] = true, ["TimeSkillX"] = "0",
    ["Skill C"] = true, ["TimeSkillC"] = "0"
}
getgenv().Sword = { 
    ["Sword"] = true,
    ["Delay"] = 1,
...
getgenv().Fruits = { 
    ...
    ["Skill X"] = true, ["TimeSkillX"] = "0",
    ["Skill C"] = true, ["TimeSkillC"] = "0",
    ["Skill V"] = true, ["TimeSkillV"] = "0",
    ["Skill F"] = true, ["TimeSkillF"] = "0"
}
getgenv().Gun = { 
    ["Gun"] = true,
    ["Delay"] = 1,
...
spawn(function()
    pcall(function()
        game:GetService("RunService").RenderStepped:connect(function()
            if getgenv().Main["StartHunt"] and TargetPlayerAim ~= nil and game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool") and game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool").Name]:FindFirstChild("MousePos") then
                local args = {
    ...
    for i = 1, 1 do
        ...
        if #bladehit > 0 then
            pcall(function()
                ...
                CmrFwLib.activeController.hitboxMagnitude = 11111
...
FruitList = {"Bomb-Bomb", "Spike-Spike", "Chop-Chop", "Spring-Spring", "Kilo-Kilo", "Spin-Spin", "Bird: Falcon", "Smoke-Smoke", "Flame-Flame", "Ice-Ice", "Sand-Sand", "Dark-Dark", "Revive-Revive", "Diamond-Diamond", "Light-Light", "Love-Love", "Rubber-Rubber", "Barrier-Barrier", "Magma-Magma", "Door-Door", "Quake-Quake", "Human-Human: Buddha", "String-String", "Bird-Bird: Phoenix", "Rumble-Rumble", "Paw-Paw", "Gravity-Gravity", "Dough-Dough", "Venom-Venom", "Shadow-Shadow", "Control-Control", "Soul-Soul", "Dragon-Dragon", "Leopart-Leopart"}
            ...
            if getgenv().Main["StartHunt"] then
                for i,v in pairs(game:GetService("Workspace").Characters:GetChildren()) do
                    if v.Name ~= game.Players.LocalPlayer.Name then
                        if v:WaitForChild("Humanoid").Health > 0 and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.HumanoidRootPart.Position).Magnitude <= 123456789 then
                                ...
                                if (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 50 then
                                    spawn(function()
                                        ...
                                        if getgenv().Melee["Skill X"] then
                                            wait(getgenv().Melee["TimeSkillX"]) X()
                                        end
                                        if getgenv().Melee["Skill C"] then
                                            wait(getgenv().Melee["TimeSkillC"]) C()
                                        end
                                        ...
                                        if getgenv().Sword["Skill Z"] then
                                            wait(getgenv().Sword["TimeSkillZ"]) Z()
                                        end
                                        if getgenv().Sword["Skill X"] then
                                            wait(getgenv().Sword["TimeSkillX"]) X()
                                        end
                                        ...
                                        if getgenv().Fruits["Skill Z"] then
                                            wait(getgenv().Fruits["TimeSkillZ"]) Z()
                                        end
                                        if getgenv().Fruits["Skill X"] then
                                            wait(getgenv().Fruits["TimeSkillX"]) X()
                                        end
                                        if getgenv().Fruits["Skill C"] then
                                            wait(getgenv().Fruits["TimeSkillC"]) C()
                                        end
                                        ...
                                        if getgenv().Gun["Skill Z"] then
                                            wait(getgenv().Gun["TimeSkillZ"]) Z()
                                        end
                                        if getgenv().Gun["Skill X"] then
                                            wait(getgenv().Gun["TimeSkillX"]) X()
                                        end
...
if getgenv().ChatWhenHunt["ChatWhenHunt"] then
    while wait(getgenv().ChatWhenHunt["TimeToChat"]) do 
        game:GetService("ReplicatedStorage"):WaitForChild("DefaultChatSystemChatEvents"):FindFirstChild("SayMessageRequest"):FireServer(getgenv().ChatWhenHunt["ChatWhenHunt"] , "All") 
   end
end
